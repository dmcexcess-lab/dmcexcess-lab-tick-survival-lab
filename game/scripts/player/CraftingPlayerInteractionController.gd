...
## Shares the existing world-cell pointer. Only current perception-filtered System-29
## highlight descriptors carrying the real Crafting action can open a workstation.
