...
const SEMANTIC_TO_GLYPH := {
    ...
    &"item.drink.sports_drink": &"glyph.drink.juice_bottle",
    ...
    &"item.food.banana": &"glyph.food.apple",
    &"item.food.carrot_bag": &"glyph.food.berries",
    &"item.food.eggs_carton": &"glyph.food.milk_carton",
    &"item.food.yogurt_cup": &"glyph.food.cheese",
    &"item.food.rice_bag": &"glyph.food.cereal_box",
    &"item.food.pasta_box": &"glyph.food.crackers",
    &"item.food.peanut_butter_jar": &"glyph.food.canned",
    ...
    &"item.kitchen.coffee_grounds": &"glyph.food.cereal_box",
    &"item.kitchen.cutlery_set": &"glyph.kitchen.can_opener",
    &"item.kitchen.dish_towel": &"glyph.material.rag_bundle",
    ...
    &"item.medical.medical_tape": &"glyph.medical.bandage",
    &"item.medical.alcohol_wipes": &"glyph.medical.disinfectant",
    ...
    &"item.tool.pliers": &"glyph.tool.wrench",
    ...
    &"item.farming.fertilizer_bag": &"glyph.farming.seed_packet",
    ...
    &"item.electrical.extension_cord": &"glyph.junk.scrap_wire",
    ...
    &"item.sanitation.toilet_paper_roll": &"glyph.sanitation.soap",
    &"item.sanitation.cleaning_spray": &"glyph.sanitation.cleaner",

    &"item.office.notebook": &"glyph.office.notebook",
    &"item.office.permanent_marker": &"glyph.office.marker",
    &"item.office.pencil_pack": &"glyph.office.marker",
    &"item.office.scissors": &"glyph.kitchen.knife",
    &"item.clothing.work_gloves": &"glyph.clothing.gloves",
    &"item.clothing.socks_pair": &"glyph.clothing.gloves",
    &"item.clothing.beanie": &"glyph.clothing.gloves",
    &"item.outdoors.tarp": &"glyph.outdoors.tarp",
    &"item.automotive.jumper_cables": &"glyph.automotive.jumper_cables",
    &"item.automotive.motor_oil_bottle": &"glyph.sanitation.cleaner",
    &"item.industrial.work_light": &"glyph.industrial.work_light",
    &"item.industrial.safety_glasses": &"glyph.clothing.gloves",
    ...
    &"item.junk.stale_newspaper": &"glyph.junk.paper_trash",
    &"item.junk.crumpled_carton": &"glyph.junk.paper_trash",
}
