...
func _initialize() -> void:
    ...
    _check(global_plan != null and global_plan.is_generated(), "current System 00D v8 world generates before streaming")
...
func _test_upstream_regressions(planner: GlobalWorldPlanner, global_plan: GeneratedGlobalWorldPlan) -> void:
    _check(global_plan.profile_version == 8, "00F consumes temperate.rural.region v8 without changing it")
