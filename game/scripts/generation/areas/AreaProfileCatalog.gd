...
func profile(profile_id: StringName) -> Dictionary:
    ...
    if profile_id == SMALLTOWN_CENTER:
        return {
            ...
            "island_large_residential_count": 88,
            "island_large_local_residential_target": 64,
            "island_large_town_cross_offset_candidates": [128, 148, 168, 188, 208],
            "island_large_town_back_offset_candidates": [112, 132, 152, 172, 192],
            "island_large_town_core_half_extent": 252,
