...
func profile(profile_id: StringName) -> Dictionary:
    ...
    if profile_id == SMALLTOWN_CENTER:
        return {
            ...
            "commercial_count": 7,
            "residential_count": 88,
            "farmstead_count": 0,
            "local_residential_target": 64,
            "local_farmstead_target": 0,
            "local_town_width": 3,
            "town_cross_offset_candidates": [128, 148, 168, 188, 208],
            "town_back_offset_candidates": [112, 132, 152, 172, 192],
            "town_street_extension": 10,
            "town_core_half_extent": 252,
