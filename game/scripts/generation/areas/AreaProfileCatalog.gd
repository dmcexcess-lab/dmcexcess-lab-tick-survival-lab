...
func profile(profile_id: StringName) -> Dictionary:
    if profile_id == RURAL_CROSSROADS:
        return {
            ...
            "commercial_count": 3,
            "residential_count": 6,
            "island_overrides": {"residential_count": 14, "local_residential_target": 7},
            "farmstead_count": 4,
    ...
    if profile_id == SMALLTOWN_CENTER:
        return {
            ...
            "island_large_minimum_size": 512,
            "island_large_residential_count": 100,
            "island_large_local_residential_target": 56,
            "island_large_town_cross_offset_candidates": [144, 156, 168, 180, 192],
            "island_large_town_back_offset_candidates": [136, 148, 160, 172, 184],
            "island_large_town_core_half_extent": 224,
    ...
    if profile_id == RURAL_SCATTERED:
        return {
            ...
            "commercial_count": 0,
            "residential_count": 4,
            "island_overrides": {"residential_count": 10, "farmstead_count": 4, "local_residential_target": 7},
            "farmstead_count": 2,
            "local_residential_target": 3,
