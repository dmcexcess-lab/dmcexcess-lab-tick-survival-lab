...
func profile(profile_id: StringName) -> Dictionary:
    ...
    if profile_id == SMALLTOWN_CENTER:
        return {
            ...
            "island_large_minimum_size": 384,
            "island_large_residential_count": 48,
            "island_large_local_residential_target": 32,
            "island_large_town_cross_offset_candidates": [72, 84, 96, 108, 120],
            "island_large_town_back_offset_candidates": [64, 76, 88, 100, 112],
            "island_large_town_core_half_extent": 148,
