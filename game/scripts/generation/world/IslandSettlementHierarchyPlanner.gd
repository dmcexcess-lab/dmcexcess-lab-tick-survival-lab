...
func _settlement_specs(profile: Dictionary) -> Array[Dictionary]:
    ...
    return [
        _spec("settlement.smalltown.001", "area.smalltown.center.001", &"smalltown", &"smalltown.center", smalltown_radius, 640, 0, town_spacing, Vector2i(640, 640)),
        _spec("settlement.smalltown.002", "area.smalltown.center.002", &"smalltown", &"smalltown.center", smalltown_radius, 640, 4, town_spacing, Vector2i(640, 640)),
