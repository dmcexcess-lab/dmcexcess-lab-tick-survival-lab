...
- Streaming/materialization may hide a large persistent world behind bounded active work, but crossing a technical boundary must not be allowed to monopolize the player's render/input frame.
...
The extended implementation doctrine lives in `PERFORMANCE_NORTH_STAR.md`.
