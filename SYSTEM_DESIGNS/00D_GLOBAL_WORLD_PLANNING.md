...
## Current island density — 2026-09-05

`temperate.island.region` v8 preserves the 3072×3072 island envelope, two town anchors, three crossroads and six rural lane sites. Town envelopes are now 512×512, allowing longer streets and more actual houses without reducing parcel gaps. Crossroads remain small service communities and rural sites retain at most fourteen home/farm buildings. Intervening island surface still adds no independent farmsteads; distributed off-site habitation is a separate follow-up, not claimed complete here.
